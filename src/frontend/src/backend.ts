...
import type { Booking as _Booking, Status as _Status, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitBooking(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async submitBookingAsUser(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBookingAsUser(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBookingStatus(arg0: bigint, arg1: string): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "cancelled" in value ? Status.cancelled : "pending" in value ? Status.pending : "inTransit" in value ? Status.inTransit : "delivered" in value ? Status.delivered : "confirmed" in value ? Status.confirmed : value;
}
